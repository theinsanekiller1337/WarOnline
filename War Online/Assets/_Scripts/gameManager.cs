...
public class gameManager : Photon.PunBehaviour {
    ...
    private void Start()
    {
        ...
        else
        {
            ...
            if (RTCTankController.LocalPlayerInstance == null)
            {
                ...
                PhotonNetwork.Instantiate(this.playerPrefab.name, spawnPoints[PhotonNetwork.room.PlayerCount - 1].position, spawnPoints[PhotonNetwork.room.PlayerCount - 1].rotation, 0);
            }
            else
            {
    ...
    // Note: It's 2:30am and I just want to flex on Srijian and the boys before I sleep for work later.
